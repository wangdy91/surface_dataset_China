...
inFile_b11  = 'surfdata_140x80pt_ECMWF_hist_16pfts_Irrig_CMIP6_simyr2000_c201130_b11.nc';
inDirFile_b11 = [inDir, '\', inFile_b11];
inFile_b12  = 'surfdata_140x80pt_ECMWF_hist_16pfts_Irrig_CMIP6_simyr2000_c201129_b12.nc';
inDirFile_b12 = [inDir, '\', inFile_b12];

outFile = 'surfdata_280x80pt_North_China_ECMWF_hist_16pfts_Irrig_CMIP6_simyr2000_c201202.nc';
...
mxsoil_color_b11 = ncread(inDirFile_b11, 'mxsoil_color');
mxsoil_color_b12 = ncread(inDirFile_b12, 'mxsoil_color');
mxsoil_color_cmb = max(mxsoil_color_b11, mxsoil_color_b12);

SOIL_COLOR_b11 = ncread(inDirFile_b11, 'SOIL_COLOR');
SOIL_COLOR_b12 = ncread(inDirFile_b12, 'SOIL_COLOR');
SOIL_COLOR_cmb = cat(1, SOIL_COLOR_b11, SOIL_COLOR_b12);

PCT_SAND_b11 = ncread(inDirFile_b11, 'PCT_SAND');
PCT_SAND_b12 = ncread(inDirFile_b12, 'PCT_SAND');
PCT_SAND_cmb = cat(1, PCT_SAND_b11, PCT_SAND_b12);
 
PCT_CLAY_b11 = ncread(inDirFile_b11, 'PCT_CLAY');
PCT_CLAY_b12 = ncread(inDirFile_b12, 'PCT_CLAY');
PCT_CLAY_cmb = cat(1, PCT_CLAY_b11, PCT_CLAY_b12);

ORGANIC_b11 = ncread(inDirFile_b11, 'ORGANIC');
ORGANIC_b12 = ncread(inDirFile_b12, 'ORGANIC');
ORGANIC_cmb = cat(1,ORGANIC_b11, ORGANIC_b12);

FMAX_b11    = ncread(inDirFile_b11, 'FMAX');
FMAX_b12    = ncread(inDirFile_b12, 'FMAX');
FMAX_cmb    = cat(1, FMAX_b11, FMAX_b12);

natpft_b11  = ncread(inDirFile_b11, 'natpft');
natpft_b12  = ncread(inDirFile_b12, 'natpft');
natpft_cmb  = natpft_b11;  % size: 15x1

cft_b11     = ncread(inDirFile_b11, 'cft');
cft_b12     = ncread(inDirFile_b12, 'cft');
cft_cmb     = cft_b11;     % size: 2x1
 
LANDFRAC_PFT_b11 = ncread(inDirFile_b11, 'LANDFRAC_PFT');
LANDFRAC_PFT_b12 = ncread(inDirFile_b12, 'LANDFRAC_PFT');
LANDFRAC_PFT_cmb = cat(1, LANDFRAC_PFT_b11, LANDFRAC_PFT_b12);

PFTDATA_MASK_b11 = ncread(inDirFile_b11, 'PFTDATA_MASK');
PFTDATA_MASK_b12 = ncread(inDirFile_b12, 'PFTDATA_MASK');
PFTDATA_MASK_cmb = cat(1, PFTDATA_MASK_b11, PFTDATA_MASK_b12);
 
PCT_NATVEG_b11  = ncread(inDirFile_b11, 'PCT_NATVEG');
PCT_NATVEG_b12  = ncread(inDirFile_b12, 'PCT_NATVEG');
PCT_NATVEG_cmb  = cat(1, PCT_NATVEG_b11, PCT_NATVEG_b12); 

PCT_CROP_b11     = ncread(inDirFile_b11, 'PCT_CROP');
PCT_CROP_b12     = ncread(inDirFile_b12, 'PCT_CROP');
PCT_CROP_cmb    = cat(1, PCT_CROP_b11, PCT_CROP_b12);
  
PCT_NAT_PFT_b11 = ncread(inDirFile_b11, 'PCT_NAT_PFT');
PCT_NAT_PFT_b12 = ncread(inDirFile_b12, 'PCT_NAT_PFT');
PCT_NAT_PFT_cmb = cat(1, PCT_NAT_PFT_b11, PCT_NAT_PFT_b12);
 
PCT_CFT_b11     = ncread(inDirFile_b11, 'PCT_CFT');
PCT_CFT_b12     = ncread(inDirFile_b12, 'PCT_CFT');
PCT_CFT_cmb     = cat(1, PCT_CFT_b11, PCT_CFT_b12);

MONTHLY_LAI_b11 = ncread(inDirFile_b11, 'MONTHLY_LAI');
MONTHLY_LAI_b12 = ncread(inDirFile_b12, 'MONTHLY_LAI');
MONTHLY_LAI_cmb = cat(1, MONTHLY_LAI_b11, MONTHLY_LAI_b12);

MONTHLY_SAI_b11 = ncread(inDirFile_b11, 'MONTHLY_SAI');
MONTHLY_SAI_b12 = ncread(inDirFile_b12, 'MONTHLY_SAI');
MONTHLY_SAI_cmb = cat(1, MONTHLY_SAI_b11, MONTHLY_SAI_b12);

MONTHLY_HEIGHT_TOP_b11 = ncread(inDirFile_b11, 'MONTHLY_HEIGHT_TOP');
MONTHLY_HEIGHT_TOP_b12 = ncread(inDirFile_b12, 'MONTHLY_HEIGHT_TOP');
MONTHLY_HEIGHT_TOP_cmb = cat(1, MONTHLY_HEIGHT_TOP_b11, MONTHLY_HEIGHT_TOP_b12);
 
MONTHLY_HEIGHT_BOT_b11 = ncread(inDirFile_b11, 'MONTHLY_HEIGHT_BOT');
MONTHLY_HEIGHT_BOT_b12 = ncread(inDirFile_b12, 'MONTHLY_HEIGHT_BOT');
MONTHLY_HEIGHT_BOT_cmb = cat(1, MONTHLY_HEIGHT_BOT_b11, MONTHLY_HEIGHT_BOT_b12);

time_b11    = ncread(inDirFile_b11, 'time');
time_b12    = ncread(inDirFile_b12, 'time');
time_cmb    = time_b11;   % size 12x1
 
AREA_b11    = ncread(inDirFile_b11, 'AREA');
AREA_b12    = ncread(inDirFile_b12, 'AREA');
AREA_cmb    = cat(1, AREA_b11, AREA_b12);
 
LONGXY_b11  = ncread(inDirFile_b11, 'LONGXY');
LONGXY_b12  = ncread(inDirFile_b12, 'LONGXY');
LONGXY_cmb  = cat(1, LONGXY_b11, LONGXY_b12);

LATIXY_b11 = ncread(inDirFile_b11, 'LATIXY');
LATIXY_b12 = ncread(inDirFile_b12, 'LATIXY');
LATIXY_cmb = cat(1, LATIXY_b11, LATIXY_b12);
 
EF1_BTR_b11 = ncread(inDirFile_b11, 'EF1_BTR');
EF1_BTR_b12 = ncread(inDirFile_b12, 'EF1_BTR');
EF1_BTR_cmb = cat(1, EF1_BTR_b11, EF1_BTR_b12);

EF1_FET_b11 = ncread(inDirFile_b11, 'EF1_FET');
EF1_FET_b12 = ncread(inDirFile_b12, 'EF1_FET');
EF1_FET_cmb = cat(1, EF1_FET_b11, EF1_FET_b12);

EF1_FDT_b11 = ncread(inDirFile_b11, 'EF1_FDT');
EF1_FDT_b12 = ncread(inDirFile_b12, 'EF1_FDT');
EF1_FDT_cmb = cat(1, EF1_FDT_b11, EF1_FDT_b12);

EF1_SHR_b11 = ncread(inDirFile_b11, 'EF1_SHR');
EF1_SHR_b12 = ncread(inDirFile_b12, 'EF1_SHR');
EF1_SHR_cmb = cat(1, EF1_SHR_b11, EF1_SHR_b12);
 
EF1_GRS_b11 = ncread(inDirFile_b11, 'EF1_GRS');
EF1_GRS_b12 = ncread(inDirFile_b12, 'EF1_GRS');
EF1_GRS_cmb = cat(1, EF1_GRS_b11, EF1_GRS_b12);
 
EF1_CRP_b11 = ncread(inDirFile_b11, 'EF1_CRP');
EF1_CRP_b12 = ncread(inDirFile_b12, 'EF1_CRP');
EF1_CRP_cmb = cat(1, EF1_CRP_b11, EF1_CRP_b12);

CANYON_HWR_b11 = ncread(inDirFile_b11, 'CANYON_HWR');
CANYON_HWR_b12 = ncread(inDirFile_b12, 'CANYON_HWR');
CANYON_HWR_cmb = cat(1, CANYON_HWR_b11, CANYON_HWR_b12);
 
EM_IMPROAD_b11 = ncread(inDirFile_b11, 'EM_IMPROAD');
EM_IMPROAD_b12 = ncread(inDirFile_b12, 'EM_IMPROAD');
EM_IMPROAD_cmb = cat(1, EM_IMPROAD_b11, EM_IMPROAD_b12);

EM_PERROAD_b11 = ncread(inDirFile_b11, 'EM_PERROAD');
EM_PERROAD_b12 = ncread(inDirFile_b12, 'EM_PERROAD');
EM_PERROAD_cmb = cat(1, EM_PERROAD_b11, EM_PERROAD_b12);
 
EM_ROOF_b11 = ncread(inDirFile_b11, 'EM_ROOF');
EM_ROOF_b12 = ncread(inDirFile_b12, 'EM_ROOF');
EM_ROOF_cmb = cat(1, EM_ROOF_b11, EM_ROOF_b12);

EM_WALL_b11 = ncread(inDirFile_b11, 'EM_WALL');
EM_WALL_b12 = ncread(inDirFile_b12, 'EM_WALL');
EM_WALL_cmb = cat(1, EM_WALL_b11, EM_WALL_b12);
 
HT_ROOF_b11 = ncread(inDirFile_b11, 'HT_ROOF');
HT_ROOF_b12 = ncread(inDirFile_b12, 'HT_ROOF');
HT_ROOF_cmb = cat(1, HT_ROOF_b11, HT_ROOF_b12);
 
THICK_ROOF_b11 = ncread(inDirFile_b11, 'THICK_ROOF');
THICK_ROOF_b12 = ncread(inDirFile_b12, 'THICK_ROOF');
THICK_ROOF_cmb = cat(1, THICK_ROOF_b11, THICK_ROOF_b12);

THICK_WALL_b11 = ncread(inDirFile_b11, 'THICK_WALL');
THICK_WALL_b12 = ncread(inDirFile_b12, 'THICK_WALL');
THICK_WALL_cmb = cat(1, THICK_WALL_b11, THICK_WALL_b12);
 
T_BUILDING_MIN_b11 = ncread(inDirFile_b11, 'T_BUILDING_MIN');
T_BUILDING_MIN_b12 = ncread(inDirFile_b12, 'T_BUILDING_MIN');
T_BUILDING_MIN_cmb = cat(1, T_BUILDING_MIN_b11, T_BUILDING_MIN_b12);

WIND_HGT_CANYON_b11 = ncread(inDirFile_b11, 'WIND_HGT_CANYON');
WIND_HGT_CANYON_b12 = ncread(inDirFile_b12, 'WIND_HGT_CANYON');
WIND_HGT_CANYON_cmb = cat(1, WIND_HGT_CANYON_b11, WIND_HGT_CANYON_b12);
 
WTLUNIT_ROOF_b11 = ncread(inDirFile_b11, 'WTLUNIT_ROOF');
WTLUNIT_ROOF_b12 = ncread(inDirFile_b12, 'WTLUNIT_ROOF');
WTLUNIT_ROOF_cmb = cat(1, WTLUNIT_ROOF_b11, WTLUNIT_ROOF_b12);

WTROAD_PERV_b11 = ncread(inDirFile_b11, 'WTROAD_PERV');
WTROAD_PERV_b12 = ncread(inDirFile_b12, 'WTROAD_PERV');
WTROAD_PERV_cmb = cat(1, WTROAD_PERV_b11, WTROAD_PERV_b12);
 
ALB_IMPROAD_DIR_b11 = ncread(inDirFile_b11, 'ALB_IMPROAD_DIR');
ALB_IMPROAD_DIR_b12 = ncread(inDirFile_b12, 'ALB_IMPROAD_DIR');
ALB_IMPROAD_DIR_cmb = cat(1, ALB_IMPROAD_DIR_b11, ALB_IMPROAD_DIR_b12);

ALB_IMPROAD_DIF_b11 = ncread(inDirFile_b11, 'ALB_IMPROAD_DIF');
ALB_IMPROAD_DIF_b12 = ncread(inDirFile_b12, 'ALB_IMPROAD_DIF');
ALB_IMPROAD_DIF_cmb = cat(1, ALB_IMPROAD_DIF_b11, ALB_IMPROAD_DIF_b12);
 
ALB_PERROAD_DIR_b11 = ncread(inDirFile_b11, 'ALB_PERROAD_DIR');
ALB_PERROAD_DIR_b12 = ncread(inDirFile_b12, 'ALB_PERROAD_DIR');
ALB_PERROAD_DIR_cmb = cat(1, ALB_PERROAD_DIR_b11, ALB_PERROAD_DIR_b12);
 
ALB_PERROAD_DIF_b11 = ncread(inDirFile_b11, 'ALB_PERROAD_DIF');
ALB_PERROAD_DIF_b12 = ncread(inDirFile_b12, 'ALB_PERROAD_DIF');
ALB_PERROAD_DIF_cmb = cat(1, ALB_PERROAD_DIF_b11, ALB_PERROAD_DIF_b12);

ALB_ROOF_DIR_b11 = ncread(inDirFile_b11, 'ALB_ROOF_DIR');
ALB_ROOF_DIR_b12 = ncread(inDirFile_b12, 'ALB_ROOF_DIR');
ALB_ROOF_DIR_cmb = cat(1, ALB_ROOF_DIR_b11, ALB_ROOF_DIR_b12);
 
ALB_ROOF_DIF_b11 = ncread(inDirFile_b11, 'ALB_ROOF_DIF');
ALB_ROOF_DIF_b12 = ncread(inDirFile_b12, 'ALB_ROOF_DIF');
ALB_ROOF_DIF_cmb = cat(1, ALB_ROOF_DIF_b11, ALB_ROOF_DIF_b12);

ALB_WALL_DIR_b11 = ncread(inDirFile_b11, 'ALB_WALL_DIR');
ALB_WALL_DIR_b12 = ncread(inDirFile_b12, 'ALB_WALL_DIR');
ALB_WALL_DIR_cmb = cat(1, ALB_WALL_DIR_b11, ALB_WALL_DIR_b12);

ALB_WALL_DIF_b11 = ncread(inDirFile_b11, 'ALB_WALL_DIF');
ALB_WALL_DIF_b12 = ncread(inDirFile_b12, 'ALB_WALL_DIF');
ALB_WALL_DIF_cmb = cat(1, ALB_WALL_DIF_b11, ALB_WALL_DIF_b12);

TK_ROOF_b11 = ncread(inDirFile_b11, 'TK_ROOF');
TK_ROOF_b12 = ncread(inDirFile_b12, 'TK_ROOF');
TK_ROOF_cmb = cat(1, TK_ROOF_b11, TK_ROOF_b12);
 
TK_WALL_b11 = ncread(inDirFile_b11, 'TK_WALL');
TK_WALL_b12 = ncread(inDirFile_b12, 'TK_WALL');
TK_WALL_cmb = cat(1, TK_WALL_b11, TK_WALL_b12);

TK_IMPROAD_b11 = ncread(inDirFile_b11, 'TK_IMPROAD');
TK_IMPROAD_b12 = ncread(inDirFile_b12, 'TK_IMPROAD');
TK_IMPROAD_cmb = cat(1, TK_IMPROAD_b11, TK_IMPROAD_b12);
 
CV_ROOF_b11 = ncread(inDirFile_b11, 'CV_ROOF');
CV_ROOF_b12 = ncread(inDirFile_b12, 'CV_ROOF');
CV_ROOF_cmb = cat(1, CV_ROOF_b11, CV_ROOF_b12);

CV_WALL_b11 = ncread(inDirFile_b11, 'CV_WALL');
CV_WALL_b12 = ncread(inDirFile_b12, 'CV_WALL');
CV_WALL_cmb = cat(1, CV_WALL_b11, CV_WALL_b12);
 
CV_IMPROAD_b11 = ncread(inDirFile_b11, 'CV_IMPROAD');
CV_IMPROAD_b12 = ncread(inDirFile_b12, 'CV_IMPROAD');
CV_IMPROAD_cmb = cat(1, CV_IMPROAD_b11, CV_IMPROAD_b12);

NLEV_IMPROAD_b11 = ncread(inDirFile_b11, 'NLEV_IMPROAD');
NLEV_IMPROAD_b12 = ncread(inDirFile_b12, 'NLEV_IMPROAD');
NLEV_IMPROAD_cmb = cat(1, NLEV_IMPROAD_b11, NLEV_IMPROAD_b12);

peatf_b11 = ncread(inDirFile_b11, 'peatf');
peatf_b12 = ncread(inDirFile_b12, 'peatf');
peatf_cmb = cat(1, peatf_b11, peatf_b12);

zbedrock_b11 = ncread(inDirFile_b11, 'zbedrock');
zbedrock_b12 = ncread(inDirFile_b12, 'zbedrock');
zbedrock_cmb = cat(1, zbedrock_b11, zbedrock_b12);

abm_b11 = ncread(inDirFile_b11, 'abm');
abm_b12 = ncread(inDirFile_b12, 'abm');
abm_cmb = cat(1, abm_b11, abm_b12);

gdp_b11 = ncread(inDirFile_b11, 'gdp');
gdp_b12 = ncread(inDirFile_b12, 'gdp');
gdp_cmb = cat(1, gdp_b11, gdp_b12);

SLOPE_b11 = ncread(inDirFile_b11, 'SLOPE');
SLOPE_b12 = ncread(inDirFile_b12, 'SLOPE');
SLOPE_cmb = cat(1, SLOPE_b11, SLOPE_b12);
 
STD_ELEV_b11 = ncread(inDirFile_b11, 'STD_ELEV');
STD_ELEV_b12 = ncread(inDirFile_b12, 'STD_ELEV');
STD_ELEV_cmb = cat(1, STD_ELEV_b11, STD_ELEV_b12);

LAKEDEPTH_b11 = ncread(inDirFile_b11, 'LAKEDEPTH');
LAKEDEPTH_b12 = ncread(inDirFile_b12, 'LAKEDEPTH');
LAKEDEPTH_cmb = cat(1, LAKEDEPTH_b11, LAKEDEPTH_b12);
 
PCT_WETLAND_b11 = ncread(inDirFile_b11, 'PCT_WETLAND');
PCT_WETLAND_b12 = ncread(inDirFile_b12, 'PCT_WETLAND');
PCT_WETLAND_cmb = cat(1, PCT_WETLAND_b11, PCT_WETLAND_b12);
 
PCT_LAKE_b11 = ncread(inDirFile_b11, 'PCT_LAKE');
PCT_LAKE_b12 = ncread(inDirFile_b12, 'PCT_LAKE');
PCT_LAKE_cmb = cat(1, PCT_LAKE_b11, PCT_LAKE_b12);
 
PCT_GLACIER_b11 = ncread(inDirFile_b11, 'PCT_GLACIER');
PCT_GLACIER_b12 = ncread(inDirFile_b12, 'PCT_GLACIER');
PCT_GLACIER_cmb = cat(1, PCT_GLACIER_b11, PCT_GLACIER_b12);
 
GLACIER_REGION_b11 = ncread(inDirFile_b11, 'GLACIER_REGION');
GLACIER_REGION_b12 = ncread(inDirFile_b12, 'GLACIER_REGION');
GLACIER_REGION_cmb = cat(1, GLACIER_REGION_b11, GLACIER_REGION_b12);
 
GLC_MEC_b11 = ncread(inDirFile_b11, 'GLC_MEC');
GLC_MEC_b12 = ncread(inDirFile_b12, 'GLC_MEC');
GLC_MEC_cmb = GLC_MEC_b11;   % size 11x1
 
PCT_GLC_MEC_b11 = ncread(inDirFile_b11, 'PCT_GLC_MEC');
PCT_GLC_MEC_b12 = ncread(inDirFile_b12, 'PCT_GLC_MEC');
PCT_GLC_MEC_cmb = cat(1, PCT_GLC_MEC_b11, PCT_GLC_MEC_b12);
 
TOPO_GLC_MEC_b11 = ncread(inDirFile_b11, 'TOPO_GLC_MEC');
TOPO_GLC_MEC_b12 = ncread(inDirFile_b12, 'TOPO_GLC_MEC');
TOPO_GLC_MEC_cmb = cat(1, TOPO_GLC_MEC_b11, TOPO_GLC_MEC_b12);
 
PCT_URBAN_b11 = ncread(inDirFile_b11, 'PCT_URBAN');
PCT_URBAN_b12 = ncread(inDirFile_b12, 'PCT_URBAN');
PCT_URBAN_cmb = cat(1, PCT_URBAN_b11, PCT_URBAN_b12);

URBAN_REGION_ID_b11 = ncread(inDirFile_b11, 'URBAN_REGION_ID');
URBAN_REGION_ID_b12 = ncread(inDirFile_b12, 'URBAN_REGION_ID');
URBAN_REGION_ID_cmb = cat(1, URBAN_REGION_ID_b11, URBAN_REGION_ID_b12);
 
CONST_HARVEST_VH1_b11 = ncread(inDirFile_b11, 'CONST_HARVEST_VH1');
CONST_HARVEST_VH1_b12 = ncread(inDirFile_b12, 'CONST_HARVEST_VH1');
CONST_HARVEST_VH1_cmb = cat(1, CONST_HARVEST_VH1_b11, CONST_HARVEST_VH1_b12);
 
CONST_HARVEST_VH2_b11 = ncread(inDirFile_b11, 'CONST_HARVEST_VH2');
CONST_HARVEST_VH2_b12 = ncread(inDirFile_b12, 'CONST_HARVEST_VH2');
CONST_HARVEST_VH2_cmb = cat(1, CONST_HARVEST_VH2_b11, CONST_HARVEST_VH2_b12);
 
CONST_HARVEST_SH1_b11 = ncread(inDirFile_b11, 'CONST_HARVEST_SH1');
CONST_HARVEST_SH1_b12 = ncread(inDirFile_b12, 'CONST_HARVEST_SH1');
CONST_HARVEST_SH1_cmb = cat(1, CONST_HARVEST_SH1_b11, CONST_HARVEST_SH1_b12);
 
CONST_HARVEST_SH2_b11 = ncread(inDirFile_b11, 'CONST_HARVEST_SH2');
CONST_HARVEST_SH2_b12 = ncread(inDirFile_b12, 'CONST_HARVEST_SH2');
CONST_HARVEST_SH2_cmb = cat(1, CONST_HARVEST_SH2_b11, CONST_HARVEST_SH2_b12);
 
CONST_HARVEST_SH3_b11 = ncread(inDirFile_b11, 'CONST_HARVEST_SH3');
CONST_HARVEST_SH3_b12 = ncread(inDirFile_b12, 'CONST_HARVEST_SH3');
CONST_HARVEST_SH3_cmb = cat(1, CONST_HARVEST_SH3_b11, CONST_HARVEST_SH3_b12);
 
CONST_GRAZING_b11 = ncread(inDirFile_b11, 'CONST_GRAZING');
CONST_GRAZING_b12 = ncread(inDirFile_b12, 'CONST_GRAZING');
CONST_GRAZING_cmb = cat(1, CONST_GRAZING_b11, CONST_GRAZING_b12);
 
CONST_FERTNITRO_CFT_b11 = ncread(inDirFile_b11, 'CONST_FERTNITRO_CFT');
CONST_FERTNITRO_CFT_b12 = ncread(inDirFile_b12, 'CONST_FERTNITRO_CFT');
CONST_FERTNITRO_CFT_cmb = cat(1, CONST_FERTNITRO_CFT_b11, CONST_FERTNITRO_CFT_b12);
 
UNREPRESENTED_PFT_LULCC_b11 = ncread(inDirFile_b11, 'UNREPRESENTED_PFT_LULCC');
UNREPRESENTED_PFT_LULCC_b12 = ncread(inDirFile_b12, 'UNREPRESENTED_PFT_LULCC');
UNREPRESENTED_PFT_LULCC_cmb = cat(1, UNREPRESENTED_PFT_LULCC_b11, UNREPRESENTED_PFT_LULCC_b12);
 
UNREPRESENTED_CFT_LULCC_b11 = ncread(inDirFile_b11, 'UNREPRESENTED_CFT_LULCC');
UNREPRESENTED_CFT_LULCC_b12 = ncread(inDirFile_b12, 'UNREPRESENTED_CFT_LULCC');
UNREPRESENTED_CFT_LULCC_cmb = cat(1, UNREPRESENTED_CFT_LULCC_b11, UNREPRESENTED_CFT_LULCC_b12);
