...
inFile_b11  = 'domain.lnd.280x80pt_South_China_ECMWF_noocean.201201.nc';
inDirFile_b11 = [inDir, '\', inFile_b11];
inFile_b12  = 'domain.lnd.280x80pt_North_China_ECMWF_noocean.201202.nc';
inDirFile_b12 = [inDir, '\', inFile_b12];

outFile = 'domain.lnd.280x160pt_China_ECMWF_noocean.201202.nc';
...
njdimID = netcdf.defDim(outid, 'nj', 160);
